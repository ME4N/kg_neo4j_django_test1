...
def main(_):
    ...
    wordembedding = np.load('./data_rela/vec.npy')

    print('reading training data')
    train_y = np.load('./data_rela/train_y.npy')
    train_word = np.load('./data_rela/train_word.npy')
    train_pos1 = np.load('./data_rela/train_pos1.npy')
    train_pos2 = np.load('./data_rela/train_pos2.npy')
